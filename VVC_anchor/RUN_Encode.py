...
qplist=['38']#[ "37", "42", "47", "52"]

inputdir='/home/ysz/datasets/testing_sequence_30/' ###You should download the testing sequence and modify the dir.

Inputformat='YUV420' # 'RGB444' OR 'YUV420'
testingdata_name='VOXCELEB' # 'CFVQA' OR 'VOXCELEB' ## 'CFVQA' OR 'VOXCELEB'  ###You should choose which dataset to be encoded.
