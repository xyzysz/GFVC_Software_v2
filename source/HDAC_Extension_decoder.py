...
if __name__ == "__main__":
    ...
    ##
    model_name = "HDAC_Extension"

    model_config_path= './GFVC/HDAC/checkpoint/HDAC-256.yaml'
    model_checkpoint_path= './GFVC/HDAC/checkpoint/HDAC-checkpoint.pth.tar'     
    ...
    dec_sequence_path_rgb =dec_output_path+seq+'_qp'+str(qp)+'_bqp'+str(bl_qp)+'.rgb'
    dec_sequence_path_mp4 =dec_output_path+seq+'_qp'+str(qp)+'_bqp'+str(bl_qp)+'.mp4'
